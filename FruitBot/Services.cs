...
//// From https://gist.github.com/foxbot/7d81edab4e36497c643828638af289b8
...
//            _logger = loggerFactory.CreateLogger("ReliabilityService");
//            //_logger = logger ?? (_ => Task.CompletedTask);

//            InfoAsync("Discord reliability service starting.");
...
//        {
//            _logger.Log(logLevel: LogLevel.Critical, message: message, exception: error);
//            return Task.CompletedTask;
//        }
//    }
//}